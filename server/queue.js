...
const VALID_PRODUCTS = ['website', 'booking', 'ivr', 'urgent', 'mobile']
...
const PRODUCT_LABELS = { website: 'website', booking: 'booking system', ivr: 'phone robot (IVR)', urgent: 'urgent service', mobile: 'mobile dispatch' }
